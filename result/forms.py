...
class CreateResultForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["classes"].widget.attrs["class"] = "block max-w-lg w-full shadow-sm focus: ring-indigo-500 focus: border-indigo-500 sm: text-sm border-gray-700  border-b-2 border-black"
        ...
        self.fields["term"].widget.attrs["class"] = "block max-w-lg w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-700 border-b-2 "
        self.fields["number_of_subjects_taken"].widget.attrs["class"] = "block max-w-lg w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 border-b-2 "
        self.fields["minimum_subjects"].widget.attrs["class"] = "block max-w-lg w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-700 border-b-2 "
        self.fields["marks_obtained"].widget.attrs["class"] = "block max-w-lg w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-700 border-b-2 "
        self.fields["number_of_failures"].widget.attrs["class"] = "block max-w-lg w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-700 border-b-2 "
